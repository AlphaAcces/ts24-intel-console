  ...
  if (variant === 'header') {
    return (
      <div
        ...
        aria-label={t('common.logo.alt', { defaultValue: 'TS24 Intelligence' })}
      >
        <div className="relative">
          {/* Logo mark - stylized T with gold gradient */}
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-[var(--color-gold)] to-[var(--color-copper)] shadow-lg">
            <span className="text-lg font-black text-[var(--color-background)] tracking-tighter">T</span>
          </div>
          {/* Subtle glow effect */}
          <div className="absolute inset-0 rounded-lg bg-[var(--color-gold)] opacity-20 blur-md -z-10" />
        </div>
        <div className="flex flex-col leading-none">
          <span className="text-base font-bold text-[var(--color-text)] tracking-tight">TS24</span>
    ...
    return (
      ...
      >
        <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-gradient-to-br from-[var(--color-gold)] to-[var(--color-copper)] shadow-md">
          <span className="text-sm font-black text-[var(--color-background)] tracking-tighter">T</span>
        </div>
      </div>
    );
  }
  ...
  return (
    ...
    >
      <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-[var(--color-gold)] to-[var(--color-copper)] shadow-lg">
        <span className="text-xl font-black text-[var(--color-background)] tracking-tighter">T</span>
      </div>
      <div className="flex flex-col leading-none">
        <span className="text-lg font-bold text-[var(--color-text)] tracking-tight">TS24</span>
